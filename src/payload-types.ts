...
export interface Course {
  ...
  /**
   * Solo para cursos MS. Indica a qué track pertenece este curso.
   */
  subProgram?: ('profundizacion' | 'investigacion' | 'compartido') | null;
  /**
  ...
  weeks?: number | null;
  nrc?: string | null;
  modality?: ('PRESENCIAL' | 'VIRTUAL' | 'HÍBRIDA') | null;
  scheduleSlots?:
    | {
  ...
  /**
   * Cursos o condiciones que deben cumplirse antes. Deja vacío si no aplica.
   */
  prerequisites?: string | null;
  /**
   * Cursos que deben tomarse simultáneamente. Deja vacío si no aplica.
   */
  corequisites?: string | null;
  /**
   * Notas adicionales (ej: "Solo para estudiantes de cuarto semestre en adelante").
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "professors_select".
 */
export interface ProfessorsSelect<T extends boolean = true> {
  name?: T;
  rank?: T;
  bio?: T;
  photo?: T;
