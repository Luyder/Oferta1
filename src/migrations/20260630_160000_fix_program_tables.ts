...
// Recreates courses_obligatoria_en and courses_electiva_en without the `id` column,
// which Payload does not supply when inserting into hasMany select join tables.
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  // no-op: dropping tables without data is safe
}
